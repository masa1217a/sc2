...
/**
 * Created by masa1217 on 2015/10/24.
 */
...
public class News extends ActionBarActivity
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            ...
            case 4:
                ...
                Intent access = new Intent(this, Top.class);
                startActivityForResult(access, 0);
                break;
            case 5:
                mTitle = getString(R.string.title_section4);
                Intent schedule = new Intent(this, Schedule.class);
                startActivityForResult(schedule, 0);
                break;
            case 6:
                mTitle = getString(R.string.title_section5);
                Intent mail = new Intent(this, Top.class);
                startActivityForResult(mail, 0);
                break;
            case 7:
                mTitle = getString(R.string.title_section6);
                Intent map = new Intent(this, Top.class);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((News) activity).onSectionAttached(
